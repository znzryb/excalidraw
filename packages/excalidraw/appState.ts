...
> => {
  return {
    ...
    activeToolPropertiesPanelHidden: false,
    openMenu: null,
    openPopup: null,
    openSidebar: null,
    openDialog: null,
...
>(config: { [K in keyof T]: K extends keyof AppState ? T[K] : never }) =>
  ...
  pdfPageMoveDocId: { browser: false, export: false, server: false },
  pdfPageMoveFrameId: { browser: false, export: false, server: false },
